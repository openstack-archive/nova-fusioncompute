...
class FusionComputeDriverStartupTestCase(test.NoDBTestCase):
    def setUp(self):
        ...
        self.patcher = mock.patch('nova.fusioncompute.virt.huaweiapi.'
                                  'driver.FusionComputeDriver.__init__')
        ...
        self.driver.cluster_ops = fc_cluster.ClusterOps(
            self.driver._client, self.driver.task_ops)
