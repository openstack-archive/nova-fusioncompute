...
class FusionComputeDriver(compute_driver.ComputeDriver):
    ...
    def get_resource_group_list(self):
        ...
        if node_list:
            for node in node_list:
                cluster_urn = self.cluster_ops.get_cluster_urn_by_nodename(node)
                resource_groups_per_cluster = self.cluster_ops.get_resource_group_list(cluster_urn)
    ...
    def power_off(self, instance, timeout=0, retry_interval=0, forceStop=False):
    ...
    def reboot(self, context, instance, network_info, reboot_type,
        ...
        def _reboot_vm_fc():
            ...
            """
            try:
                self.compute_ops.reboot_vm(instance, reboot_type, block_device_info)
            except Exception as ex:
    ...
    def live_migration(self, context, instance_ref, dest,
        ...
        def _live_migration():
            ...
            :return:
            """
            self.compute_ops.live_migration(context, instance_ref, dest,
    ...
    def node_is_available(self, nodename):
        ...
        return nodename in self.get_available_nodes_without_exception(refresh=True)
    ...
    def attach_interface(self, instance, image_meta, vif):
        ...
        def attach_intf_inner():
            ...
            """
            extra_specs = self.get_instance_extra_specs(instance)
            return self.compute_ops.attach_interface(instance, vif, extra_specs)
        try:
    ...
    def migrate_disk_and_power_off(self, context, instance, dest, flavor,
        ...
        def _migrate_disk_and_power_off():
            ...
            :return:
            """
            self.compute_ops.migrate_disk_and_power_off(instance, dest, flavor, block_device_info)
    ...
    def finish_migration(self, context, migration, instance, disk_info,
        ...
        def _finish_migration():
            ...
            :return:
            """
            self.compute_ops.finish_migration(instance, power_on, block_device_info)
        _finish_migration()
    ...
    def finish_revert_migration(self, context, instance, network_info,
        ...
        def _finish_revert_migration():
            ...
            :return:
            """
            self.compute_ops.finish_revert_migration(instance, power_on, block_device_info)
